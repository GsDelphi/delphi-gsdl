...
unit GsPreProcessorThemeModuleTemplates;
...
type
  TGsThemeModuleParams = class(TJclTemplateParams)
  private
    FHookDll: Boolean;
    FFileName: string;
...
//=== { TGsThemeModuleParams } ===================================================

constructor TGsThemeModuleParams.Create;
begin
  inherited Create;
...
destructor TGsThemeModuleParams.Destroy;
begin
  FIgnoredExceptions.Free;
  inherited Destroy;
end;

function TGsThemeModuleParams.GetIgnoredException: string;
begin
  Result := FIgnoredExceptions.Strings[FIgnoredExceptionsIndex];
end;

function TGsThemeModuleParams.GetIgnoredExceptionsCount: Integer;
begin
  Result := FIgnoredExceptions.Count;
end;

function TGsThemeModuleParams.GetReportAllThreads: Boolean;
begin
  Result := FAllThreads or FAllRegisteredThreads;
end;

function TGsThemeModuleParams.GetReportExceptionThread: Boolean;
begin
  Result := FExceptionThread or FMainExceptionThreads;
end;

function TGsThemeModuleParams.GetReportMainThread: Boolean;
begin
