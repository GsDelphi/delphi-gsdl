...
{$IFDEF USE_CS}
  CodeSiteLogging,
{$ENDIF}
  Messages, Windows, Classes, Graphics, Forms, Controls, DesignIntf,
  DesignEditors, StdCtrls, ExtCtrls, Buttons, GsConsts,
  // RzCommon,
  RzLabel, RzPanel, RzBorder, RzStatus, RzBckgnd, RzBmpBtn, RzButton, jpeg;

type
  TGsAboutBoxProperty = class(TPropertyEditor)
  public
...
resourcestring
  sCopyrightDate = '1998-2018';
  sCompanyName = 'Raize Software, Inc.';
  sProductVersion = 'Version ' + PRODUCT_VERSION;
{$IFDEF RAIZETRIAL}
  sProductName = 'Raize Components ' + PRODUCT_VERSION + ' - Trial Edition';
{$ELSE}
  sProductName = 'Raize Components ' + PRODUCT_VERSION;
{$ENDIF}
...
resourcestring
  ...
  sRzDBCheckBoxGroup =
    'The Check Box state of this data-aware TRzGroupBox is controlled by the connected data field.';
  ...
  sRzDateTimePicker =
    'This component has been deprecated--Use the TRzDateTimeEdit instead.';
  sRzDBEdit =
  ...
  sRzDBDateTimePicker =
    'This component has been deprecated--Use the TRzDBDateTimeEdit instead.';
  ...
  sRzStringGrid =
    'This enhanced string grid supports Custom Framing as well as additional display options for grid cells.';
  sRzDBListBox =
  ...
  sRzDBGrid =
    'This enhanced data-aware grid supports Custom Framing as well as additional display options for grid cells.';
  ...
  sRzToolbarButton =
    'This component has been deprecated--Use the TRzToolButton instead.';
  sRzMenuToolbarButton =
    'This component has been deprecated--Use the TRzToolButton instead.';
  sRzDBNavigator =
  ...
  sRzVersionInfoStatus =
    'This TRzFieldStatus descendant displays the specified field of the connected TRzVersionInfo component.';
  sRzResourceStatus =
  ...
  sRzProgressDisplay =
    'This custom graphic component displays progress steps (i.e. text messages) in a scrolling window display.';
  sRzMeter =
  ...
  sRzSelectFolderDialog =
    'This custom dialog component supports selecting and creating new folders in the Shell namespace.';
  sRzDirectoryTree =
    'This component has been deprecated--Use the TRzShellTree instead.';
  sRzDirectoryListBox =
    'This component has been deprecated--Use the TRzShellTree instead.';
  sRzFileListBox =
    'This component has been deprecated--Use the TRzShellList instead.';
  sRzDriveComboBox =
    'This component has been deprecated--Use the TRzShellCombo instead.';
  sRzSelDirDialog =
    'This component has been deprecated--Use the TRzSelectFolderDialog instead.';
  ...
  sRzCalculator =
    'This custom control allows a user to perform simply math calculations.';
  sRzColorPicker =
...
function TGsAboutBoxProperty.GetAttributes: TPropertyAttributes;
begin
  Result := [paDialog, paReadOnly];
end;

function TGsAboutBoxProperty.GetValue: string;
begin
  Result := sProductVersion;
end;

procedure TGsAboutBoxProperty.Edit;
var
  Dialog: TGsAboutEditDlg;
begin
  Dialog := TGsAboutEditDlg.Create(Application);
  try
...
const
  ...
  StringTable: array [1 .. NumComponents] of TRzCompMap = (
    // Raize Panels
    (Name: 'TRzPanel'; Description: sRzPanel), (Name: 'TRzGroupBar';
    Description: sRzGroupBar), (Name: 'TRzGroupTemplate';
    Description: sRzGroupTemplate), (Name: 'TRzPageControl';
    Description: sRzPageControl), (Name: 'TRzTabControl';
    Description: sRzTabControl), (Name: 'TRzSplitter';
    Description: sRzSplitter), (Name: 'TRzSizePanel';
    Description: sRzSizePanel), (Name: 'TRzToolbar'; Description: sRzToolbar),
    (Name: 'TRzStatusBar'; Description: sRzStatusBar), (Name: 'TRzPathBar';
    Description: sRzPathBar), (Name: 'TRzGroupBox'; Description: sRzGroupBox),
    (Name: 'TRzRadioGroup'; Description: sRzRadioGroup), (Name: 'TRzCheckGroup';
    Description: sRzCheckGroup), (Name: 'TRzDBRadioGroup';
    Description: sRzDBRadioGroup), (Name: 'TRzDBCheckBoxGroup';
    Description: sRzDBCheckBoxGroup),

    // Raize Edits
    (Name: 'TRzEdit'; Description: sRzEdit), (Name: 'TRzMaskEdit';
    Description: sRzMaskEdit), (Name: 'TRzButtonEdit';
    Description: sRzButtonEdit), (Name: 'TRzDateTimeEdit';
    Description: sRzDateTimeEdit), (Name: 'TRzNumericEdit';
    Description: sRzNumericEdit), (Name: 'TRzSpinEdit';
    Description: sRzSpinEdit), (Name: 'TRzColorEdit';
    Description: sRzColorEdit), (Name: 'TRzExpandEdit';
    Description: sRzExpandEdit), (Name: 'TRzHotKeyEdit';
    Description: sRzHotKeyEdit), (Name: 'TRzMemo'; Description: sRzMemo),
    (Name: 'TRzRichEdit'; Description: sRzRichEdit), (Name: 'TRzSpinner';
    Description: sRzSpinner), (Name: 'TRzTrackBar'; Description: sRzTrackBar),
    (Name: 'TRzDateTimePicker'; Description: sRzDateTimePicker),
    (Name: 'TRzDBEdit'; Description: sRzDBEdit), (Name: 'TRzDBButtonEdit';
    Description: sRzDBButtonEdit), (Name: 'TRzDBDateTimeEdit';
    Description: sRzDBDateTimeEdit), (Name: 'TRzDBNumericEdit';
    Description: sRzDBNumericEdit), (Name: 'TRzDBSpinEdit';
    Description: sRzDBSpinEdit), (Name: 'TRzDBExpandEdit';
    Description: sRzDBExpandEdit), (Name: 'TRzDBMemo'; Description: sRzDBMemo),
    (Name: 'TRzDBRichEdit'; Description: sRzDBRichEdit), (Name: 'TRzDBSpinner';
    Description: sRzDBSpinner), (Name: 'TRzDBTrackBar';
    Description: sRzDBTrackBar), (Name: 'TRzDBDateTimePicker';
    Description: sRzDBDateTimePicker),

    // Raize Lists
    (Name: 'TRzListBox'; Description: sRzListBox), (Name: 'TRzRankListBox';
    Description: sRzRankListBox), (Name: 'TRzTabbedListBox';
    Description: sRzTabbedListBox), (Name: 'TRzCheckList';
    Description: sRzCheckList), (Name: 'TRzEditListBox';
    Description: sRzEditListBox), (Name: 'TRzFontListBox';
    Description: sRzFontListBox), (Name: 'TRzComboBox';
    Description: sRzComboBox), (Name: 'TRzImageComboBox';
    Description: sRzImageComboBox), (Name: 'TRzColorComboBox';
    Description: sRzColorComboBox), (Name: 'TRzFontComboBox';
    Description: sRzFontComboBox), (Name: 'TRzMRUComboBox';
    Description: sRzMRUComboBox), (Name: 'TRzTreeView';
    Description: sRzTreeView), (Name: 'TRzCheckTree';
    Description: sRzCheckTree), (Name: 'TRzListView'; Description: sRzListView),
    (Name: 'TRzStringGrid'; Description: sRzStringGrid), (Name: 'TRzDBListBox';
    Description: sRzDBListBox), (Name: 'TRzDBComboBox';
    Description: sRzDBComboBox), (Name: 'TRzDBLookupComboBox';
    Description: sRzDBLookupComboBox), (Name: 'TRzDBGrid';
    Description: sRzDBGrid),

    // Raize Buttons
    (Name: 'TRzButton'; Description: sRzButton), (Name: 'TRzBitBtn';
    Description: sRzBitBtn), (Name: 'TRzMenuButton';
    Description: sRzMenuButton), (Name: 'TRzDialogButtons';
    Description: sRzDialogButtons), (Name: 'TRzSpinButtons';
    Description: sRzSpinButtons), (Name: 'TRzRapidFireButton';
    Description: sRzRapidFireButton), (Name: 'TRzCheckBox';
    Description: sRzCheckBox), (Name: 'TRzRadioButton';
    Description: sRzRadioButton), (Name: 'TRzToolButton';
    Description: sRzToolButton), (Name: 'TRzSpacer'; Description: sRzSpacer),
    ...
    (Name: 'TRzLabel'; Description: sRzLabel), (Name: 'TRzURLLabel';
    Description: sRzURLLabel), (Name: 'TRzBorder'; Description: sRzBorder),
    (Name: 'TRzLine'; Description: sRzLine), (Name: 'TRzSeparator';
    Description: sRzSeparator), (Name: 'TRzStatusPane';
    Description: sRzStatusPane), (Name: 'TRzFieldStatus';
    Description: sRzFieldStatus), (Name: 'TRzGlyphStatus';
    Description: sRzGlyphStatus), (Name: 'TRzProgressStatus';
    Description: sRzProgressStatus), (Name: 'TRzMarqueeStatus';
    Description: sRzMarqueeStatus), (Name: 'TRzClockStatus';
    Description: sRzClockStatus), (Name: 'TRzKeyStatus';
    Description: sRzKeyStatus), (Name: 'TRzVersionInfoStatus';
    Description: sRzVersionInfoStatus), (Name: 'TRzResourceStatus';
    Description: sRzResourceStatus), (Name: 'TRzProgressBar';
    Description: sRzProgressBar), (Name: 'TRzProgressDisplay';
    Description: sRzProgressDisplay), (Name: 'TRzMeter'; Description: sRzMeter),
    (Name: 'TRzLEDDisplay'; Description: sRzLEDDisplay), (Name: 'TRzBackground';
    Description: sRzBackground), (Name: 'TRzAnimator';
    Description: sRzAnimator), (Name: 'TRzDBLabel'; Description: sRzDBLabel),
    ...
    // Raize Shell
    (Name: 'TRzShellTree'; Description: sRzShellTree), (Name: 'TRzShellList';
    Description: sRzShellList), (Name: 'TRzShellCombo';
    Description: sRzShellCombo), (Name: 'TRzOpenDialog';
    Description: sRzOpenDialog), (Name: 'TRzSaveDialog';
    Description: sRzSaveDialog), (Name: 'TRzSelectFolderDialog';
    Description: sRzSelectFolderDialog), (Name: 'TRzDirectoryTree';
    Description: sRzDirectoryTree), (Name: 'TRzDirectoryListBox';
    Description: sRzDirectoryListBox), (Name: 'TRzFileListBox';
    Description: sRzFileListBox), (Name: 'TRzDriveComboBox';
    Description: sRzDriveComboBox), (Name: 'TRzSelDirDialog';
    Description: sRzSelDirDialog),

    // Raize Widgets
    (Name: 'TRzCalendar'; Description: sRzCalendar), (Name: 'TRzTimePicker';
    Description: sRzTimePicker), (Name: 'TRzCalculator';
    Description: sRzCalculator), (Name: 'TRzColorPicker';
    Description: sRzColorPicker), (Name: 'TRzCustomColors';
    Description: sRzCustomColors), (Name: 'TRzRegIniFile';
    Description: sRzRegIniFile), (Name: 'TRzFormState';
    Description: sRzFormState), (Name: 'TRzFormShape';
    Description: sRzFormShape), (Name: 'TRzLauncher'; Description: sRzLauncher),
    (Name: 'TRzTrayIcon'; Description: sRzTrayIcon), (Name: 'TRzVersionInfo';
    Description: sRzVersionInfo), (Name: 'TRzBalloonHints';
    Description: sRzBalloonHints), (Name: 'TRzLookupDialog';
    Description: sRzLookupDialog), (Name: 'TRzSendMessage';
    Description: sRzSendMessage), (Name: 'TRzDBLookupDialog';
    Description: sRzDBLookupDialog));

  { ============================ }
  { == TRzAboutEditDlg Methods = }
  { ============================ }

procedure TGsAboutEditDlg.FormCreate(Sender: TObject);
begin
...
function TGsAboutEditDlg.FindDescription(CompName: string): string;
var
  I: Integer;
begin
  Result := '';
  I := 1;
  while (I <= NumComponents) and
    (CompareText(CompName, StringTable[I].Name) <> 0) do
  begin
    Inc(I);
  end;
...
procedure TGsAboutEditDlg.SetComponentName(Value: string);
begin
  if Value[1] = 'T' then
  ...
  imgCompBmp.Picture.Bitmap.Handle :=
    LoadBitmap(HInstance, PChar(UpperCase(Value)));
  imgCompBmp.Visible := True;
  imgCompBmp.Transparent := True;
end;

procedure TGsAboutEditDlg.imgCloseClick(Sender: TObject);
begin
  Close;
end;

procedure TGsAboutEditDlg.imgBackgroundMouseDown(Sender: TObject;
