...
uses CommCtrl, TypInfo, pngimage, GIFImg;
...
resourcestring
  ...
  SImageTypeTransparencyNotImplemented = 'Die Transparenz für den Bildtyp %s ist nicht implementiert und wird nicht richtig angezeigt.';
...
begin
  ...
  begin
    ...
    *)
    ...
    begin
      MessageDlg(Format(SImageTypeTransparencyNotImplemented, [Graphic.ClassName]), mtWarning, [mbOK], 0);
